...
@:keep @:bind #if display private #end class __ASSET__assets_music_stage_wav extends flash.media.Sound { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_player_piskel extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_fire_out_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_water_out_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_jump_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_buttonpressed_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_water_fill_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_grounded_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_level_complete_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_start_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_block_move_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_font_pressstart2p_svg extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_font_pressstart2p_woff extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_font_pressstart2p_ttf extends flash.text.Font { }
@:keep @:bind #if display private #end class __ASSET__assets_font_pressstart2p_eot extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maps_test_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maps_stage0_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maps_stage1_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maps_stage3_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maps_stage2_tmx extends flash.utils.ByteArray { }
