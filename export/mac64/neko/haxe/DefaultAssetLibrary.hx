...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_font_pressstart2p_ttf);
...
@:keep class __ASSET__assets_font_pressstart2p_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/font/PressStart2P.ttf"; fontName = "Press Start 2P"; }}


#else


class __ASSET__assets_font_pressstart2p_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/font/PressStart2P.ttf"; fontName = "Press Start 2P";  }}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/music/stage.ogg", "assets/music/stage.ogg");
		...
		path.set ("assets/sounds/water_out.ogg", "assets/sounds/water_out.ogg");
		...
		path.set ("assets/sounds/fire_out.ogg", "assets/sounds/fire_out.ogg");
		...
		path.set ("assets/sounds/start.ogg", "assets/sounds/start.ogg");
		type.set ("assets/sounds/start.ogg", AssetType.SOUND);
		path.set ("assets/sounds/level_complete.ogg", "assets/sounds/level_complete.ogg");
		...
		path.set ("assets/sounds/grounded.ogg", "assets/sounds/grounded.ogg");
		...
		path.set ("assets/sounds/water_fill.ogg", "assets/sounds/water_fill.ogg");
		type.set ("assets/sounds/water_fill.ogg", AssetType.SOUND);
		path.set ("assets/sounds/buttonPressed.ogg", "assets/sounds/buttonPressed.ogg");
		type.set ("assets/sounds/buttonPressed.ogg", AssetType.SOUND);
		path.set ("assets/sounds/block_move.ogg", "assets/sounds/block_move.ogg");
...
@:keep #if display private #end class __ASSET__assets_font_pressstart2p_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/font/PressStart2P.ttf"; name = "Press Start 2P"; super (); }}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_font_pressstart2p_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/font/PressStart2P.ttf"; name = "Press Start 2P"; super (); }}
