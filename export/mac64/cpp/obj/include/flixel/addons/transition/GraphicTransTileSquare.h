...
class HXCPP_CLASS_ATTRIBUTES GraphicTransTileSquare_obj : public  ::openfl::_legacy::display::BitmapData_obj
{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("GraphicTransTileSquare","\x0b","\xd3","\x33","\x22"); }
