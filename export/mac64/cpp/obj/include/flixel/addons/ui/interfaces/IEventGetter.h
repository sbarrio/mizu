...
class HXCPP_CLASS_ATTRIBUTES IEventGetter_obj {
	public:
		...
		static inline void getEvent( ::Dynamic _hx_,::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params) {
			(_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IEventGetter_obj *>(_hx_.mPtr->_hx_getInterface(0xdcf9e4f9)))->_hx_getEvent)(name,sender,data,params);
		}
		...
		static inline  ::Dynamic getRequest( ::Dynamic _hx_,::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params) {
			return (_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IEventGetter_obj *>(_hx_.mPtr->_hx_getInterface(0xdcf9e4f9)))->_hx_getRequest)(name,sender,data,params);
		}
};
