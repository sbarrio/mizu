...
class HXCPP_CLASS_ATTRIBUTES FlxUITypedButton_obj : public  ::flixel::ui::FlxTypedButton_obj
{
	...
	public:
		...
		::Dynamic doResize_dyn();
		 ...
		 ::openfl::_legacy::display::BitmapData getBmp( ::Dynamic asset);
		::Dynamic getBmp_dyn();
		...
		::Dynamic forceStateHandler_dyn();
		 ...
		 ::openfl::_legacy::display::BitmapData grabButtonFrame( ::openfl::_legacy::display::BitmapData all_frames,int button_state,hx::Null< bool >  for_toggle,hx::Null< int >  src_w,hx::Null< int >  src_h,::String key);
		::Dynamic grabButtonFrame_dyn();

		 ::openfl::_legacy::display::BitmapData combineToggleBitmaps( ::openfl::_legacy::display::BitmapData normal, ::openfl::_legacy::display::BitmapData toggle);
		::Dynamic combineToggleBitmaps_dyn();

		 ::openfl::_legacy::display::BitmapData assembleButtonFrames( ::openfl::_legacy::display::BitmapData upB, ::openfl::_legacy::display::BitmapData overB, ::openfl::_legacy::display::BitmapData downB);
