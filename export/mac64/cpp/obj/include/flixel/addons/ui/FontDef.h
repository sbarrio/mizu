...
class HXCPP_CLASS_ATTRIBUTES FontDef_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x0c57cf53 };

		void __construct(::String Name,::String __o_Extension,::String __o_File, ::openfl::_legacy::text::TextFormat Format, ::flixel::addons::ui::BorderDef Border);
		...
		static hx::ObjectPtr< FontDef_obj > __new(::String Name,::String __o_Extension,::String __o_File, ::openfl::_legacy::text::TextFormat Format, ::flixel::addons::ui::BorderDef Border);
		static hx::ObjectPtr< FontDef_obj > __alloc(hx::Ctx *_hx_ctx,::String Name,::String __o_Extension,::String __o_File, ::openfl::_legacy::text::TextFormat Format, ::flixel::addons::ui::BorderDef Border);
		...
		static  ::flixel::addons::ui::FontDef copyFromTextField( ::openfl::_legacy::text::TextField t);
		...
		::Dynamic clone_dyn();
		 ...
		 ::openfl::_legacy::text::TextField applyTxt( ::openfl::_legacy::text::TextField textField);
		::Dynamic applyTxt_dyn();

		 ::flixel::text::FlxText applyFlx( ::flixel::text::FlxText flxText);
		::Dynamic applyFlx_dyn();

		void apply( ::openfl::_legacy::text::TextField textField, ::flixel::text::FlxText flxText);
		::Dynamic apply_dyn();
