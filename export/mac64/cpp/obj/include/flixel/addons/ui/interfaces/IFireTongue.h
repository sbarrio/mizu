...
class HXCPP_CLASS_ATTRIBUTES IFireTongue_obj {
	public:
		...
		static inline ::String getFont( ::Dynamic _hx_,::String str) {
			return (_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IFireTongue_obj *>(_hx_.mPtr->_hx_getInterface(0x5661c266)))->_hx_getFont)(str);
		}
		int (hx::Object :: *_hx_getFontSize)(::String str,int size); 
		static inline int getFontSize( ::Dynamic _hx_,::String str,int size) {
			return (_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IFireTongue_obj *>(_hx_.mPtr->_hx_getInterface(0x5661c266)))->_hx_getFontSize)(str,size);
		}
};
