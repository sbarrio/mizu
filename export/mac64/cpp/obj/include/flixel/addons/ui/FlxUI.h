...
class HXCPP_CLASS_ATTRIBUTES FlxUI_obj : public  ::flixel::addons::ui::FlxUIGroup_obj
{
	...
	public:
		enum { _hx_ClassId = 0x54c34e23 };

		void __construct( ::haxe::xml::Fast data,::Dynamic ptr, ::flixel::addons::ui::FlxUI superIndex_,::Dynamic tongue_,::String __o_liveFilePath_, ::haxe::ds::StringMap uiVars_);
		...
		static hx::ObjectPtr< FlxUI_obj > __new( ::haxe::xml::Fast data,::Dynamic ptr, ::flixel::addons::ui::FlxUI superIndex_,::Dynamic tongue_,::String __o_liveFilePath_, ::haxe::ds::StringMap uiVars_);
		static hx::ObjectPtr< FlxUI_obj > __alloc(hx::Ctx *_hx_ctx, ::haxe::xml::Fast data,::Dynamic ptr, ::flixel::addons::ui::FlxUI superIndex_,::Dynamic tongue_,::String __o_liveFilePath_, ::haxe::ds::StringMap uiVars_);
		...
		static  ::haxe::xml::Fast consolidateData( ::haxe::xml::Fast data, ::haxe::xml::Fast definition,hx::Null< bool >  combineUniqueChildren);
		...
		static ::cpp::VirtualArray getParams( ::haxe::xml::Fast data);
		...
		void load( ::haxe::xml::Fast data);
		::Dynamic load_dyn();

		 ::haxe::xml::Fast unparentXML( ::haxe::xml::Fast f);
		::Dynamic unparentXML_dyn();

		void _loadPointSize( ::haxe::xml::Fast data);
		...
		void _loadGlobals( ::haxe::xml::Fast data, ::Dynamic thing);
		::Dynamic _loadGlobals_dyn();

		void _postLoad( ::haxe::xml::Fast data);
		...
		::Dynamic getAssetGroup_dyn();
		 ...
		 ::haxe::xml::Fast getMode(::String key,hx::Null< bool >  recursive);
		::Dynamic getMode_dyn();
		...
		::Dynamic getLabelStyleFromDefinition_dyn();
		 ...
		 ::flixel::addons::ui::ButtonLabelStyle getLabelStyleFromData( ::haxe::xml::Fast data);
		::Dynamic getLabelStyleFromData_dyn();

		bool checkVariable(::String key,::String otherValue,::String type,::String _hx_operator,hx::Null< bool >  recursive);
		...
		::Dynamic getVariable_dyn();
		 ...
		 ::haxe::xml::Fast getDefinition(::String key,hx::Null< bool >  recursive);
		...
		::Dynamic replaceInGroup_dyn();
		 ...
		 ::haxe::xml::Fast applyNodeConditionals( ::haxe::xml::Fast info);
		::Dynamic applyNodeConditionals_dyn();

		 ::haxe::xml::Fast applyNodeChanges( ::haxe::xml::Fast data,::String nodeName);
		::Dynamic applyNodeChanges_dyn();

		::Dynamic loadThing(::String type, ::haxe::xml::Fast data);
		::Dynamic loadThing_dyn();

		 ::haxe::xml::Fast _loadThingGetInfo( ::haxe::xml::Fast data);
		::Dynamic _loadThingGetInfo_dyn();

		void _loadTooltip(::Dynamic thing, ::haxe::xml::Fast data);
		::Dynamic _loadTooltip_dyn();

		 ::Dynamic _loadTooltipData( ::haxe::xml::Fast tNode);
		::Dynamic _loadTooltipData_dyn();

		void _loadTooltipStyle( ::haxe::xml::Fast node, ::Dynamic tt);
		::Dynamic _loadTooltipStyle_dyn();

		void _loadTooltipText( ::haxe::xml::Fast node,::String fieldName, ::Dynamic tt);
		::Dynamic _loadTooltipText_dyn();

		 ::flixel::addons::ui::Anchor _loadAnchor( ::haxe::xml::Fast data);
		::Dynamic _loadAnchor_dyn();

		::Dynamic _loadThing(::String type, ::haxe::xml::Fast data);
		::Dynamic _loadThing_dyn();

		Float _loadX( ::haxe::xml::Fast data,hx::Null< Float >  default_);
		::Dynamic _loadX_dyn();

		Float _loadY( ::haxe::xml::Fast data,hx::Null< Float >  default_);
		::Dynamic _loadY_dyn();

		Float _loadScale( ::haxe::xml::Fast data,hx::Null< Float >  default_,::String str);
		::Dynamic _loadScale_dyn();

		Float _loadScaleX( ::haxe::xml::Fast data,hx::Null< Float >  default_);
		::Dynamic _loadScaleX_dyn();

		Float _loadScaleY( ::haxe::xml::Fast data,hx::Null< Float >  default_);
		::Dynamic _loadScaleY_dyn();

		Float _loadWidth( ::haxe::xml::Fast data,hx::Null< Float >  default_,::String str,::String defaultRound);
		::Dynamic _loadWidth_dyn();

		Float _loadHeight( ::haxe::xml::Fast data,hx::Null< Float >  default_,::String str,::String defaultRound);
		::Dynamic _loadHeight_dyn();

		 ::flixel::math::FlxPoint _loadCompass( ::haxe::xml::Fast data,::String str);
		::Dynamic _loadCompass_dyn();

		void _changeParamsThing( ::haxe::xml::Fast data);
		::Dynamic _changeParamsThing_dyn();

		void _changeThing( ::haxe::xml::Fast data);
		::Dynamic _changeThing_dyn();

		void _alignThing( ::haxe::xml::Fast data,hx::Null< bool >  suppressError);
		...
		bool _checkFailure( ::haxe::xml::Fast data);
		::Dynamic _checkFailure_dyn();

		void _resizeThing(::Dynamic fo_r, ::Dynamic bounds);
		::Dynamic _resizeThing_dyn();

		void _postLoadThing(::String type, ::haxe::xml::Fast data);
		::Dynamic _postLoadThing_dyn();

		 ::flixel::addons::ui::FlxUITileTest _loadTileTest( ::haxe::xml::Fast data);
		::Dynamic _loadTileTest_dyn();

		::String _loadString( ::haxe::xml::Fast data,::String attributeName);
		::Dynamic _loadString_dyn();

		::Dynamic _loadText( ::haxe::xml::Fast data);
		::Dynamic _loadText_dyn();

		::Dynamic _loadInputText( ::haxe::xml::Fast data);
		::Dynamic _loadInputText_dyn();

		 ::flixel::addons::ui::FlxUIRadioGroup _loadRadioGroup( ::haxe::xml::Fast data);
		::Dynamic _loadRadioGroup_dyn();

		 ::flixel::addons::ui::FlxUICheckBox _loadCheckBox( ::haxe::xml::Fast data);
		::Dynamic _loadCheckBox_dyn();

		 ::flixel::addons::ui::FlxUIDropDownMenu _loadDropDownMenu( ::haxe::xml::Fast data);
		::Dynamic _loadDropDownMenu_dyn();

		bool _loadTest( ::haxe::xml::Fast data);
		::Dynamic _loadTest_dyn();

		bool _loadTestSub( ::haxe::xml::Fast node);
		::Dynamic _loadTestSub_dyn();

		 ::Dynamic parseVarValue(::String varString);
		::Dynamic parseVarValue_dyn();

		 ::flixel::addons::ui::FlxUI _loadLayout( ::haxe::xml::Fast data);
		...
		::Dynamic cleanup_dyn();
		 ...
		 ::flixel::addons::ui::FlxUI createUI( ::haxe::xml::Fast data);
		::Dynamic createUI_dyn();

		 ::flixel::addons::ui::FlxUITabMenu _loadTabMenu( ::haxe::xml::Fast data);
		::Dynamic _loadTabMenu_dyn();

		::Dynamic _loadNumericStepper( ::haxe::xml::Fast data,hx::Null< bool >  setCallback);
		::Dynamic _loadNumericStepper_dyn();

		 ::flixel::math::FlxPoint getResizeRatio( ::haxe::xml::Fast data,hx::Null< int >  defaultAxis);
		::Dynamic getResizeRatio_dyn();

		::Dynamic _loadButton( ::haxe::xml::Fast data,hx::Null< bool >  setCallback,hx::Null< bool >  isToggle,::String load_code);
		::Dynamic _loadButton_dyn();

		 ::flixel::addons::ui::FlxUIRegion _loadRegion( ::haxe::xml::Fast data);
		::Dynamic _loadRegion_dyn();

		 ::flixel::addons::ui::FlxUI9SliceSprite _load9SliceSprite( ::haxe::xml::Fast data,::String load_code);
		::Dynamic _load9SliceSprite_dyn();

		::Array< int > load9SliceSprite_scaleSub(::Array< int > slice9, ::haxe::xml::Fast data,::String src,::String srcString);
		::Dynamic load9SliceSprite_scaleSub_dyn();

		int _loadTileRule( ::haxe::xml::Fast data);
		::Dynamic _loadTileRule_dyn();

		 ::flixel::addons::ui::FlxUISprite _loadBox( ::haxe::xml::Fast data);
		::Dynamic _loadBox_dyn();

		 ::flixel::addons::ui::FlxUILine _loadLine( ::haxe::xml::Fast data);
		::Dynamic _loadLine_dyn();

		 ::flixel::addons::ui::FlxUIBar _loadBar( ::haxe::xml::Fast data);
		::Dynamic _loadBar_dyn();

		 ::flixel::addons::ui::FlxUISprite _loadSprite( ::haxe::xml::Fast data);
		::Dynamic _loadSprite_dyn();

		bool loadSmooth( ::haxe::xml::Fast scaleNode,bool defaultValue);
		::Dynamic loadSmooth_dyn();

		::String loadScaledSrc( ::haxe::xml::Fast data,::String attName,::String scaleName,hx::Null< int >  tilesWide,hx::Null< int >  tilesTall);
		...
		::Dynamic _getAnchorPos_dyn();
		 ...
		 ::flixel::addons::ui::Rounding getRound( ::haxe::xml::Fast node,::String defaultStr);
		::Dynamic getRound_dyn();

		Float doRound(Float f, ::flixel::addons::ui::Rounding round);
		::Dynamic doRound_dyn();

		 ::Dynamic calcMaxMinSize( ::haxe::xml::Fast data, ::Dynamic width, ::Dynamic height);
		...
		Float _doOperation(Float value,::String _hx_operator,Float operand);
		...
		void _loadCursor( ::haxe::xml::Fast data);
		::Dynamic _loadCursor_dyn();

		void _loadPosition( ::haxe::xml::Fast data,::Dynamic thing);
		::Dynamic _loadPosition_dyn();

		 ::flixel::addons::ui::BorderDef _loadBorder( ::haxe::xml::Fast data);
		::Dynamic _loadBorder_dyn();

		int _loadColor( ::haxe::xml::Fast data,::String colorName,hx::Null< int >  _default);
		::Dynamic _loadColor_dyn();

		 ::flixel::addons::ui::FontDef _loadFontDef( ::haxe::xml::Fast data);
		::Dynamic _loadFontDef_dyn();

		::String _loadFontFace( ::haxe::xml::Fast data);
		...
		::Dynamic formatFromCode_dyn();
		 ...
		 ::flixel::text::FlxText formatButtonText( ::haxe::xml::Fast data, ::Dynamic button);
