...
class HXCPP_CLASS_ATTRIBUTES AnchorPoint_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< AnchorPoint_obj > __new(Float Offset,::String Side,::String Flush) {
			hx::ObjectPtr< AnchorPoint_obj > __this = new AnchorPoint_obj();
			__this->__construct(Offset,Side,Flush);
			return __this;
		}

		static hx::ObjectPtr< AnchorPoint_obj > __alloc(hx::Ctx *_hx_ctx,Float Offset,::String Side,::String Flush) {
...
HXLINE(  13)		( ( ::flixel::addons::ui::AnchorPoint)(__this) )->flush = Flush;
		...
		::String __ToString() const { return HX_HCSTRING("AnchorPoint","\x7b","\x79","\x8d","\x1e"); }
