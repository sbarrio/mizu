...
class HXCPP_CLASS_ATTRIBUTES U_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< U_obj > __new() {
			hx::ObjectPtr< U_obj > __this = new U_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< U_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		static bool compareStringVars(::String variable,::String otherValue,::String type,::String _hx_operator);
		...
		static  ::openfl::_legacy::geom::Point conformToBounds( ::openfl::_legacy::geom::Point pt, ::Dynamic maxMin);
		...
		static  ::openfl::_legacy::display::BitmapData getBmp( ::Dynamic asset);
		...
		static  ::openfl::_legacy::display::BlendMode xml_blend( ::Xml x,::String att);
		...
		static  ::openfl::_legacy::display::BitmapData scaleTileBmp(::String orig_id,Float scale,int origW,int origH,hx::Null< int >  W,hx::Null< int >  H,hx::Null< bool >  smooth);
		...
		static ::Array< int > bmpToArrayIntLayer(int color_index, ::openfl::_legacy::display::BitmapData bd);
