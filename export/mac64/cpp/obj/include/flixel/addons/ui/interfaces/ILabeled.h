...
class HXCPP_CLASS_ATTRIBUTES ILabeled_obj {
	public:
		...
		static inline  ::flixel::addons::ui::FlxUIText getLabel( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::ILabeled_obj *>(_hx_.mPtr->_hx_getInterface(0xa7145b87)))->_hx_getLabel)();
		}
		...
		static inline  ::flixel::addons::ui::FlxUIText setLabel( ::Dynamic _hx_, ::flixel::addons::ui::FlxUIText t) {
			return (_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::ILabeled_obj *>(_hx_.mPtr->_hx_getInterface(0xa7145b87)))->_hx_setLabel)(t);
		}
};
