...
class HXCPP_CLASS_ATTRIBUTES FlxUIState_obj : public  ::flixel::addons::transition::FlxTransitionableState_obj
{
	...
	public:
		...
		void *_hx_getInterface(int inHash);
		 ::Dynamic getRequest_93d97691(::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params);

		void getEvent_52bebde6(::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params);
		::String __ToString() const { return HX_HCSTRING("FlxUIState","\x0b","\x3d","\xc1","\x77"); }
		...
		::Dynamic createCursor_dyn();
		 ...
		 ::flixel::addons::ui::FlxUI createUI( ::haxe::xml::Fast data,::Dynamic ptr, ::flixel::addons::ui::FlxUI superIndex_,::Dynamic tongue_,::String liveFilePath_);
		::Dynamic createUI_dyn();

		void loadUIFromData( ::haxe::xml::Fast data);
		::Dynamic loadUIFromData_dyn();

		void reloadUI( ::openfl::_legacy::events::Event e);
