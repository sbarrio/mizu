...
class HXCPP_CLASS_ATTRIBUTES IFlxUIState_obj {
	public:
		...
		static inline void getEvent( ::Dynamic _hx_,::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params) {
			(_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IFlxUIState_obj *>(_hx_.mPtr->_hx_getInterface(0x0bdac137)))->_hx_getEvent)(name,sender,data,params);
		}
		...
		static inline  ::Dynamic getRequest( ::Dynamic _hx_,::String name,::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params) {
			return (_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IFlxUIState_obj *>(_hx_.mPtr->_hx_getInterface(0x0bdac137)))->_hx_getRequest)(name,sender,data,params);
		}
		void (hx::Object :: *_hx_forceFocus)(bool b,::Dynamic thing); 
		static inline void forceFocus( ::Dynamic _hx_,bool b,::Dynamic thing) {
			(_hx_.mPtr->*( static_cast< ::flixel::addons::ui::interfaces::IFlxUIState_obj *>(_hx_.mPtr->_hx_getInterface(0x0bdac137)))->_hx_forceFocus)(b,thing);
		}
};
