...
class HXCPP_CLASS_ATTRIBUTES FlxUITooltip_obj : public  ::flixel::addons::ui::FlxUIGroup_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("FlxUITooltip","\x7d","\xa6","\x7d","\x0c"); }
		...
		static void fillFormatNulls( ::openfl::_legacy::text::TextFormat a, ::openfl::_legacy::text::TextFormat b);
