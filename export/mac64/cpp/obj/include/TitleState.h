...
class HXCPP_CLASS_ATTRIBUTES TitleState_obj : public  ::flixel::addons::ui::FlxUIState_obj
{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("TitleState","\x79","\x8d","\xa1","\x8c"); }
