...
HX_DEFINE_STACK_FRAME(_hx_pos_aaa02729071e72c2_2010_new,"flixel.addons.transition.GraphicTransTileDiamond","new",0xc69d8d48,"flixel.addons.transition.GraphicTransTileDiamond.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_LOCAL_STACK_FRAME(_hx_pos_bd8fe69546e7b6bc_1_boot,"flixel.addons.transition.GraphicTransTileDiamond","boot",0xfb57124a,"flixel.addons.transition.GraphicTransTileDiamond.boot","?",1,0x0000003f)
namespace flixel{
namespace addons{
...
void GraphicTransTileDiamond_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_aaa02729071e72c2_2010_new)
HXLINE(2076)		super::__construct(width,height,transparent,fillRGBA,null());
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::GraphicTransTileDiamond_obj::resourceName));
...
bool GraphicTransTileDiamond_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		...
		return inClassId==(int)0x7a6f551e;
	}
}
...
static hx::StaticInfo GraphicTransTileDiamond_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicTransTileDiamond_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static void GraphicTransTileDiamond_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(GraphicTransTileDiamond_obj::__mClass,"__mClass");
...
static void GraphicTransTileDiamond_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(GraphicTransTileDiamond_obj::__mClass,"__mClass");
...
{
	hx::Object *dummy = new GraphicTransTileDiamond_obj;
	GraphicTransTileDiamond_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.addons.transition.GraphicTransTileDiamond","\x56","\x89","\x73","\x88");
...
{
{
            	HX_STACKFRAME(&_hx_pos_bd8fe69546e7b6bc_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileDiamond",cb,79,c6,30);
            	}
}
