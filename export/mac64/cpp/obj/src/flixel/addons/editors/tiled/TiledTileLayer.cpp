...
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a9623e9d30997_81_base64ToByteArray,"flixel.addons.editors.tiled.TiledTileLayer","base64ToByteArray",0x153e24cf,"flixel.addons.editors.tiled.TiledTileLayer.base64ToByteArray","flixel/addons/editors/tiled/TiledTileLayer.hx",81,0x5f61a546)
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a9623e9d30997_131_resolveTile,"flixel.addons.editors.tiled.TiledTileLayer","resolveTile",0xa03c3be2,"flixel.addons.editors.tiled.TiledTileLayer.resolveTile","flixel/addons/editors/tiled/TiledTileLayer.hx",131,0x5f61a546)
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a9623e9d30997_149_get_encoding,"flixel.addons.editors.tiled.TiledTileLayer","get_encoding",0x31302834,"flixel.addons.editors.tiled.TiledTileLayer.get_encoding","flixel/addons/editors/tiled/TiledTileLayer.hx",149,0x5f61a546)
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a9623e9d30997_153_get_csvData,"flixel.addons.editors.tiled.TiledTileLayer","get_csvData",0x6c5b0ccf,"flixel.addons.editors.tiled.TiledTileLayer.get_csvData","flixel/addons/editors/tiled/TiledTileLayer.hx",153,0x5f61a546)
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a9623e9d30997_169_get_tileArray,"flixel.addons.editors.tiled.TiledTileLayer","get_tileArray",0x6cbb250a,"flixel.addons.editors.tiled.TiledTileLayer.get_tileArray","flixel/addons/editors/tiled/TiledTileLayer.hx",169,0x5f61a546)
...
HXLINE(  68)				result->uncompress(null());
            			}
            		}
            		else {
HXLINE(  73)			HX_STACK_DO_THROW(HX_("Must use base64 encoding in order to get tileArray data.",41,92,e6,4d));
            		}
HXLINE(  76)		result->set_endian(::openfl::utils::_Endian::Endian_Impl__obj::toString((int)1));
...
HX_DEFINE_DYNAMIC_FUNC0(TiledTileLayer_obj,getByteArrayData,return )
 ...
 ::openfl::_legacy::utils::ByteArray TiledTileLayer_obj::base64ToByteArray(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_6e8a9623e9d30997_81_base64ToByteArray)
HXLINE(  82)		 ::openfl::_legacy::utils::ByteArray output =  ::openfl::_legacy::utils::ByteArray_obj::__alloc( HX_CTX ,null());
HXLINE(  85)		::Array< int > lookup = ::Array_obj< int >::__new();
HXLINE(  87)		{
HXLINE(  87)			int _g1 = (int)0;
HXDLIN(  87)			int _g = HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",da,a1,d5,a3).length;
HXDLIN(  87)			while((_g1 < _g)){
HXLINE(  87)				_g1 = (_g1 + (int)1);
HXDLIN(  87)				int c = (_g1 - (int)1);
HXLINE(  89)				lookup[HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",da,a1,d5,a3).charCodeAt(c)] = c;
            			}
            		}
HXLINE(  92)		int i = (int)0;
HXLINE(  93)		while((i < (data.length - (int)3))){
HXLINE(  96)			bool _hx_tmp;
HXDLIN(  96)			bool _hx_tmp1;
HXDLIN(  96)			if ((data.charAt(i) != HX_(" ",20,00,00,00))) {
HXLINE(  96)				_hx_tmp1 = (data.charAt(i) == HX_("\n",0a,00,00,00));
            			}
            			else {
HXLINE(  96)				_hx_tmp1 = true;
            			}
HXDLIN(  96)			if (!(_hx_tmp1)) {
HXLINE(  96)				_hx_tmp = (data.charAt(i) == HX_("\r",0d,00,00,00));
            			}
            			else {
...
HXLINE( 102)			int a0 = lookup->__get(data.charCodeAt(i));
HXLINE( 103)			int a1 = lookup->__get(data.charCodeAt((i + (int)1)));
HXLINE( 104)			int a2 = lookup->__get(data.charCodeAt((i + (int)2)));
HXLINE( 105)			int a3 = lookup->__get(data.charCodeAt((i + (int)3)));
HXLINE( 108)			if ((a1 < (int)64)) {
HXLINE( 110)				output->ensureElem(output->position,true);
HXDLIN( 110)				::Array< unsigned char > output1 = output->b;
HXDLIN( 110)				int _hx_tmp2 = output->position++;
HXDLIN( 110)				output1[_hx_tmp2] = (((int)a0 << (int)(int)2) + ((int)((int)a1 & (int)(int)48) >> (int)(int)4));
            			}
HXLINE( 112)			if ((a2 < (int)64)) {
HXLINE( 114)				output->ensureElem(output->position,true);
HXDLIN( 114)				::Array< unsigned char > output2 = output->b;
HXDLIN( 114)				int _hx_tmp3 = output->position++;
HXDLIN( 114)				output2[_hx_tmp3] = (((int)((int)a1 & (int)(int)15) << (int)(int)4) + ((int)((int)a2 & (int)(int)60) >> (int)(int)2));
            			}
HXLINE( 116)			if ((a3 < (int)64)) {
HXLINE( 118)				output->ensureElem(output->position,true);
HXDLIN( 118)				::Array< unsigned char > output3 = output->b;
HXDLIN( 118)				int _hx_tmp4 = output->position++;
HXDLIN( 118)				output3[_hx_tmp4] = (((int)((int)a2 & (int)(int)3) << (int)(int)6) + a3);
            			}
HXLINE( 121)			i = (i + (int)4);
            		}
HXLINE( 125)		output->position = (int)0;
HXLINE( 127)		return output;
            	}
...
int TiledTileLayer_obj::resolveTile(int globalTileId){
            	HX_GC_STACKFRAME(&_hx_pos_6e8a9623e9d30997_131_resolveTile)
HXLINE( 132)		 ::flixel::addons::editors::tiled::TiledTile tile =  ::flixel::addons::editors::tiled::TiledTile_obj::__alloc( HX_CTX ,globalTileId);
HXLINE( 134)		int tilesetID = tile->tilesetID;
HXLINE( 135)		{
HXLINE( 135)			 ::Dynamic tileset = this->map->tilesets->iterator();
HXDLIN( 135)			while(( (bool)(tileset->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 135)				 ::flixel::addons::editors::tiled::TiledTileSet tileset1 = ( ( ::flixel::addons::editors::tiled::TiledTileSet)(tileset->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 137)				bool _hx_tmp;
HXDLIN( 137)				if ((tilesetID >= tileset1->firstGID)) {
HXLINE( 137)					_hx_tmp = (tilesetID < (tileset1->firstGID + tileset1->numTiles));
            				}
            				else {
HXLINE( 137)					_hx_tmp = false;
            				}
HXDLIN( 137)				if (_hx_tmp) {
HXLINE( 139)					this->tiles->push(tile);
HXLINE( 140)					return tilesetID;
            				}
            			}
            		}
HXLINE( 143)		this->tiles->push(null());
...
::String TiledTileLayer_obj::get_encoding(){
            	HX_STACKFRAME(&_hx_pos_6e8a9623e9d30997_149_get_encoding)
HXDLIN( 149)		if (hx::IsNotNull( this->encoding )) {
HXDLIN( 149)			return this->encoding;
            		}
            		else {
HXDLIN( 149)			return this->xmlData->att->resolve(HX_("encoding",d3,8c,58,30));
            		}
...
::String TiledTileLayer_obj::get_csvData(){
            	HX_STACKFRAME(&_hx_pos_6e8a9623e9d30997_153_get_csvData)
HXLINE( 154)		if (hx::IsNull( this->csvData )) {
HXLINE( 156)			if ((this->xmlData->att->resolve(HX_("encoding",d3,8c,58,30)) == HX_("csv",c6,83,4b,00))) {
HXLINE( 158)				this->csvData = ::StringTools_obj::ltrim(this->xmlData->get_innerData());
            			}
            			else {
HXLINE( 162)				HX_STACK_DO_THROW(HX_("Must use CSV encoding in order to get CSV data.",05,1a,fa,a5));
            			}
            		}
HXLINE( 165)		return this->csvData;
            	}
...
::Array< int > TiledTileLayer_obj::get_tileArray(){
            	HX_STACKFRAME(&_hx_pos_6e8a9623e9d30997_169_get_tileArray)
HXLINE( 170)		if (hx::IsNull( this->tileArray )) {
HXLINE( 172)			this->tileArray = ::Array_obj< int >::__new();
HXLINE( 174)			if ((this->get_encoding() == HX_("csv",c6,83,4b,00))) {
HXLINE( 176)				::String endline;
HXDLIN( 176)				if ((this->get_csvData().indexOf(HX_("\r\n",5d,0b,00,00),null()) != (int)-1)) {
HXLINE( 176)					endline = HX_("\r\n",5d,0b,00,00);
            				}
            				else {
HXLINE( 176)					endline = HX_("\n",0a,00,00,00);
            				}
HXLINE( 177)				::Array< ::String > rows = this->get_csvData().split(endline);
HXLINE( 179)				{
HXLINE( 179)					int _g = (int)0;
HXDLIN( 179)					while((_g < rows->length)){
HXLINE( 179)						::String row = rows->__get(_g);
HXDLIN( 179)						_g = (_g + (int)1);
HXLINE( 181)						::Array< ::String > cells = row.split(HX_(",",2c,00,00,00));
HXLINE( 182)						{
HXLINE( 182)							int _g1 = (int)0;
HXDLIN( 182)							while((_g1 < cells->length)){
HXLINE( 182)								::String cell = cells->__get(_g1);
HXDLIN( 182)								_g1 = (_g1 + (int)1);
HXLINE( 184)								if ((cell != HX_("",00,00,00,00))) {
HXLINE( 186)									::Array< int > _hx_tmp = this->tileArray;
HXDLIN( 186)									_hx_tmp->push(::Std_obj::parseInt(cell));
            								}
            							}
            						}
            					}
...
HXLINE( 193)				 ::openfl::_legacy::utils::ByteArray mapData = this->getByteArrayData();
HXLINE( 195)				if (hx::IsNull( mapData )) {
HXLINE( 197)					HX_STACK_DO_THROW(HX_("Must use Base64 encoding (with or without zlip compression) in order to get 1D Array.",13,2f,11,cb));
            				}
HXLINE( 200)				while(true){
HXLINE( 200)					int _hx_tmp1 = ::Std_obj::_hx_int(mapData->position);
HXDLIN( 200)					if (!((_hx_tmp1 < ::Std_obj::_hx_int(mapData->length)))) {
HXLINE( 200)						goto _hx_goto_11;
            					}
HXLINE( 202)					::Array< int > _hx_tmp2 = this->tileArray;
HXDLIN( 202)					_hx_tmp2->push(this->resolveTile(mapData->readUnsignedInt()));
            				}
            				_hx_goto_11:;
            			}
            		}
HXLINE( 207)		return this->tileArray;
            	}
