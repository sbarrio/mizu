...
bool AnchorPoint_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0a6aa438;
}
...
void AnchorPoint_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("flush","\xc4","\x62","\x9b","\x02"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo AnchorPoint_obj_sMemberStorageInfo[] = {
	{hx::fsFloat,(int)offsetof(AnchorPoint_obj,offset),HX_HCSTRING("offset","\x93","\x97","\x3f","\x60")},
	{hx::fsString,(int)offsetof(AnchorPoint_obj,side),HX_HCSTRING("side","\x97","\x8d","\x53","\x4c")},
	{hx::fsString,(int)offsetof(AnchorPoint_obj,flush),HX_HCSTRING("flush","\xc4","\x62","\x9b","\x02")},
	{ hx::fsUnknown, 0, null()}
};
...
static void AnchorPoint_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AnchorPoint_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AnchorPoint_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(AnchorPoint_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new AnchorPoint_obj;
	AnchorPoint_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.addons.ui.AnchorPoint","\xea","\x0f","\xf1","\x0d");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = AnchorPoint_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AnchorPoint_obj_sVisitStatics;
#endif
