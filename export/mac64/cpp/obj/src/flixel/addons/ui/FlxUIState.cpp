...
HX_LOCAL_STACK_FRAME(_hx_pos_060bddf2a47172f7_281_openSubState,"flixel.addons.ui.FlxUIState","openSubState",0x6db12c8d,"flixel.addons.ui.FlxUIState.openSubState","flixel/addons/ui/FlxUIState.hx",281,0xa272d441)
HX_LOCAL_STACK_FRAME(_hx_pos_060bddf2a47172f7_293_closeSubState,"flixel.addons.ui.FlxUIState","closeSubState",0x6976bdd7,"flixel.addons.ui.FlxUIState.closeSubState","flixel/addons/ui/FlxUIState.hx",293,0xa272d441)
...
HXLINE( 140)		this->_ui = this->createUI(null(),hx::ObjectPtr<OBJ_>(this),null(),this->_tongue,null());
...
HXLINE( 149)			_hx_tmp = (this->_xml_id != HX_("",00,00,00,00));
            		}
            		else {
...
HXDLIN( 185)					 ::Dynamic Data = ((HX_("FlxUISubState: Could not load _xml_id \"",93,ad,c0,63) + this->_xml_id) + HX_("\"",22,00,00,00));
            				}
            			}
            			else {
...
void FlxUIState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_060bddf2a47172f7_281_openSubState)
HXDLIN( 281)		this->super::openSubState(SubState);
            	}


void FlxUIState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_060bddf2a47172f7_293_closeSubState)
HXDLIN( 293)		this->super::closeSubState();
            	}
