...
bool CheckStyle_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x234fa4dc) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x234fa4dc;
	} else {
		return inClassId==(int)0x3d0f9f72;
	}
}
...
HXLINE( 514)			c->set_color(this->checkColor);
            		}
...
{
	outFields->push(HX_HCSTRING("checkColor","\x7b","\x73","\x4c","\x5a"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo CheckStyle_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(CheckStyle_obj,checkColor),HX_HCSTRING("checkColor","\x7b","\x73","\x4c","\x5a")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String CheckStyle_obj_sMemberFields[] = {
	HX_HCSTRING("checkColor","\x7b","\x73","\x4c","\x5a"),
	HX_HCSTRING("applyToCheck","\x7f","\x31","\xa8","\x51"),
	::String(null()) };

static void CheckStyle_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(CheckStyle_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void CheckStyle_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new CheckStyle_obj;
	CheckStyle_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.addons.ui.CheckStyle","\xda","\xf7","\xbd","\x9a");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = CheckStyle_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = CheckStyle_obj_sVisitStatics;
#endif
