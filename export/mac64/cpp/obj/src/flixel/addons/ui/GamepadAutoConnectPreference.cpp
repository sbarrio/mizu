...
static void GamepadAutoConnectPreference_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(GamepadAutoConnectPreference_obj::FirstActive,"FirstActive");
	HX_MARK_MEMBER_NAME(GamepadAutoConnectPreference_obj::LastActive,"LastActive");
	HX_MARK_MEMBER_NAME(GamepadAutoConnectPreference_obj::Never,"Never");
};

#ifdef HXCPP_VISIT_ALLOCS
static void GamepadAutoConnectPreference_obj_sVisitStatic(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(GamepadAutoConnectPreference_obj::__mClass,"__mClass");
	HX_VISIT_MEMBER_NAME(GamepadAutoConnectPreference_obj::FirstActive,"FirstActive");
	HX_VISIT_MEMBER_NAME(GamepadAutoConnectPreference_obj::LastActive,"LastActive");
	HX_VISIT_MEMBER_NAME(GamepadAutoConnectPreference_obj::Never,"Never");
};
#endif
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("flixel.addons.ui.GamepadAutoConnectPreference","\xe6","\xf3","\xf3","\x18"), hx::TCanCast< GamepadAutoConnectPreference_obj >,GamepadAutoConnectPreference_obj_sStaticFields,0,
	&__Create_GamepadAutoConnectPreference_obj, &__Create,
	&super::__SGetClass(), &CreateGamepadAutoConnectPreference_obj, GamepadAutoConnectPreference_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , GamepadAutoConnectPreference_obj_sVisitStatic
#endif
...
{
FirstActive = hx::CreateEnum< GamepadAutoConnectPreference_obj >(HX_HCSTRING("FirstActive","\xf6","\x09","\x1b","\xdf"),1,0);
LastActive = hx::CreateEnum< GamepadAutoConnectPreference_obj >(HX_HCSTRING("LastActive","\xdc","\x28","\xd2","\xd7"),2,0);
Never = hx::CreateEnum< GamepadAutoConnectPreference_obj >(HX_HCSTRING("Never","\x6c","\xae","\x5d","\x2c"),0,0);
}
