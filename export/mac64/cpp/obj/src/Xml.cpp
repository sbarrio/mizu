...
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_263_attributes,"Xml","attributes",0x1ab5462e,"Xml.attributes","/usr/local/lib/haxe/std/Xml.hx",263,0x5c1024e4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7e4d842269e66db1_354_insertChild,"Xml","insertChild",0xe554966c,"Xml.insertChild","/usr/local/lib/haxe/std/Xml.hx",354,0x5c1024e4)
...
HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,exists,return )
 ...
 ::Dynamic Xml_obj::attributes(){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_263_attributes)
...
void Xml_obj::insertChild( ::Xml x,int pos){
            	HX_STACKFRAME(&_hx_pos_7e4d842269e66db1_354_insertChild)
HXLINE( 355)		bool _hx_tmp;
HXDLIN( 355)		if ((this->nodeType != ::Xml_obj::Document)) {
HXLINE( 355)			_hx_tmp = (this->nodeType != ::Xml_obj::Element);
            		}
            		else {
HXLINE( 355)			_hx_tmp = false;
            		}
HXDLIN( 355)		if (_hx_tmp) {
HXLINE( 355)			HX_STACK_DO_THROW((HX_("Bad node type, expected Element or Document but found ",a0,d6,ba,79) + this->nodeType));
            		}
HXLINE( 356)		if (hx::IsNotNull( x->parent )) {
HXLINE( 357)			x->parent->children->remove(x);
            		}
HXLINE( 359)		this->children->insert(pos,x);
HXLINE( 360)		x->parent = hx::ObjectPtr<OBJ_>(this);
            	}
