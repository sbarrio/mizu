...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("sbarrio",98,29,ad,02),HX_("LD40",f4,fd,6f,32),HX_("com.example.myapp",84,30,57,c1),HX_("1.0",b3,56,25,00));
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)640,(int)480,(int)30,(int)0,((int)((int)((int)((int)((int)((int)((int)((int)((int)((int)::openfl::_legacy::Lib_obj::HARDWARE | (int)::openfl::_legacy::Lib_obj::ALLOW_SHADERS) | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::RESIZABLE) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::VSYNC) | (int)(int)0) | (int)(int)0) | (int)(int)0),HX_("MIZU",17,21,1d,33),null(),null());
            	}
